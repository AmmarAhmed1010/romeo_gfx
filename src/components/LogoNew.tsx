  ...
  return (
    <div className="flex justify-center items-center">
      <div className="w-[280px] h-[280px] sm:w-[200px] sm:h-[200px] md:w-[350px] md:h-[350px] lg:w-[400px] lg:h-[400px] xl:w-[450px] xl:h-[450px]">
        ...
        <div
          className={cn(
            "group w-full h-full cursor-pointer overflow-hidden relative card mx-auto flex justify-center items-center border border-transparent dark:border-neutral-800",
