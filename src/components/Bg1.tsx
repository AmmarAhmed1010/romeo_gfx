...
const Bg1 = () => {
  return (
    ...
    <div className="h-full w-full  bg-black relative flex items-center justify-center antialiased">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full max-w-5xl mx-auto p-8">
        ...
        <div className="flex flex-col items-start">
          ...
          <div className=" bg-clip-text text-4xl font-serif font-bold bg-no-repeat text-transparent bg-gradient-to-r py-4 from-yellow-500 via-red-500 to-white [text-shadow:0_0_rgba(0,0,0,0.1)]">
             <span className="text-white">I Am</span> <span className="">RomeoGFX</span>
            </div>
